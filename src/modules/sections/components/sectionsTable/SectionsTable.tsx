...
import SectionRowTable from "./SectionRowTable";
import { usePermissionStore } from "@/hooks/usePermissionStore";

function SectionsTable({ type: propType }: { type: string }) {
  ...
  const { data: sections, isPending } = useGetSections({
    type,
    page,
    parent_id,
  });

  const t = useTranslations("Dashboard.SectionPage");
  const tsubsections = useTranslations("Dashboard.SubSectionPage");
  const tmerchantCategories = useTranslations(
    "Dashboard.MerchantCategoriesPage",
  );
  ...
  > = {
    ...
    SUB_CATIGORIES: {
      ...
      permission: "sub-sections",
    },
    MERCHANTS_CATIGORIES: {
      title: tmerchantCategories("title"),
      createLabel: tmerchantCategories("createNewSection"),
      description: tmerchantCategories("createSectionDescription"),
      caption: tmerchantCategories("tableCaption"),
      permission: "sections",
    },
  };
