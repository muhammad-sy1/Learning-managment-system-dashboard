        ...
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1.45fr)_minmax(0,0.95fr)]">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <StatCard
              ...
              value={
                stats ? stats.users.total_instructors.toLocaleString() : "—"
              }
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="mt-1 text-2xl font-semibold tabular-nums">
                        {stats
                          ? stats.users.new_this_month.toLocaleString()
                          : "—"}
                      </p>
                    </div>
                ...
                <div className="rounded-2xl border border-border/70 bg-muted/70 p-4">
                  <div className="flex items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="mt-1 text-2xl font-semibold tabular-nums">
                        {stats
                          ? stats.users.pending_instructors.toLocaleString()
                          : "—"}
                      </p>
                    </div>
                    <Badge variant="outline">
                      {t("usersSection.approvals")}
                    </Badge>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="rounded-2xl border border-border/70 bg-muted/70 p-4">
                  <div className="flex items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="mt-1 text-2xl font-semibold tabular-nums">
                        {stats
                          ? stats.enrollments.new_this_month.toLocaleString()
                          : "—"}
                      </p>
                    </div>
                    <Badge variant="outline">
                      {t("enrollmentsSection.monthly")}
                    </Badge>
                  </div>
                </div>
              </CardContent>
